...
BUTTONSCONTACT = InlineKeyboardMarkup([[InlineKeyboardButton(text="📞 Contact", url="https://t.me/BINDAAS_BHAI")]])
keyboard = InlineKeyboardMarkup(
    [
        [
            InlineKeyboardButton(text="🛠️ Help", url="https://t.me/BINDAAS_BHAI"),
            InlineKeyboardButton(text="🛠️ Repo", url="https://t.me/BINDAAS_BHAI"),
        ],
    ]
)
...
async def start(bot, m: Message):
    ...
    if m.chat.id in AUTH_USERS:
        await start_message.edit_text(
            ...
            f"If you face any problem contact -  [kutal ji](https://t.me/BINDAAS_BHAI)\n", disable_web_page_preview=True, reply_markup=BUTTONSCONTACT
        )
    else:
        ...
        await start_message.edit_text(
           ...
           f"If you want to buy membership of the bot, https://t.me/BINDAAS_BHAI.\n", disable_web_page_preview=True, reply_markup=keyboard
    )
