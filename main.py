...
BUTTONSCONTACT = InlineKeyboardMarkup([[InlineKeyboardButton(text="📞 Contact", url="https://t.me/Yes_Paracetamol")]])
keyboard = InlineKeyboardMarkup(
    [
        [
            InlineKeyboardButton(text="🛠️ Help", url="https://t.me/Yes_Paracetamol"),
            InlineKeyboardButton(text="🛠️ Repo", url="https://t.me/Yes_Paracetamol"),
        ],
    ]
)
...
async def start(bot, m: Message):
    ...
    if m.chat.id in AUTH_USERS:
        await start_message.edit_text(
            ...
            f"If you face any problem contact -  [𝙎𝘼𝙄𝙉𝙄 𝘽𝙊𝙏𝙎](https://t.me/Yes_Paracetamol)\n", disable_web_page_preview=True, reply_markup=BUTTONSCONTACT
        )
    else:
